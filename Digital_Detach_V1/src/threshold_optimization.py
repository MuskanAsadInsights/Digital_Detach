...
# ============================================================
print("\n" + "="*60)
print("FINAL RESEARCH DECISIONS")
print("="*60)

print("""
DECISION 1: BINARY CLASSIFICATION
The system identifies 'Severe' cases by isolating users reaching 
the maximum score threshold (10.0), effectively treating the 
ceiling effect as a diagnostic marker.

DECISION 2: SMOTE IMPLEMENTATION
Although the imbalance ratio is acceptable (1.03:1), SMOTE is 
implemented to ensure decision boundary stability for the 
Vision API inference phase in FYP-2.

DECISION 3: FEATURE ENGINEERING
The 93% accuracy is achieved by combining these thresholds with 
interaction ratios (Checking Intensity, Usage-Sleep Ratio) 
rather than raw addiction scores alone.
""")
print("="*60)